...
def analizeFile(sourceFile,resultFile):#analize the source file and save the information in the result file
    ...
    f.write("Modality;OMP;BlockSize;tree_creation_time;Kernel_search_time;program_execution_time;speedup;efficiency\n")
        ...
        for ompKey in ompList:
            ...
            for cudaKey in cudaList:
                ...
                if typeKey != "Sequential":
                    speedup = data["Sequential"]['0']['0'][2] / data[typeKey][ompKey][cudaKey][2]
